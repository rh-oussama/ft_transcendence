...
<header class="w-full px-8 py-3 bg-[#1E1E2F] flex justify-between items-center shadow-lg">
    ...
    <div class="flex items-center gap-6 font-mono text-sm text-gray-400">
        ...
        <button aria-label="Game Information" title="Game Information" class="p-2 rounded hover:bg-[#5A6A9B]/20 transition">
...
<section class="flex-1 rounded-3xl shadow-lg bg-[#1E1E2F] flex justify-center items-center relative">
    <canvas id="gameCanvas" width="960" height="540" class="max-w-full max-h-full rounded-3xl border border-[#3B3B4F]" style="background: radial-gradient(circle at center, #2e2e3e, #1e1e2f);"></canvas>
</section>
  `;
}
